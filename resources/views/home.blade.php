                    ...
                    <table class="table">
                        ...
                        <tbody>
                          ...
                          <tr>
                              ...
                              <th class="d-flex">
                                  <a href="{{ route('usuario-edit', ['id'=>$usuario->id]) }}" class="btn btn-primary me-2"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil" viewBox="0 0 16 16">
